...
percentile. For AUCs including all RASSes, these values are `r paste(quantile(df_discharge$rass_auc_total, probs = c(0.75, 0.25), na.rm = TRUE), collapse = " vs ")`; for AUCs including only RASSes on sedation, they are `r paste(quantile(df_discharge$rass_auc_sed, probs = c(0.75, 0.25), na.rm = TRUE), collapse = " vs ")`.
