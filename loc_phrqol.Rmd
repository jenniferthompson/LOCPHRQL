...
Area under the curve (AUC) of lowest daily RASS's distance from 0 during hospitalization *(calculated using linear interpolation, with missing values
interpolated with the closest non-missing data point)*. Lowest daily RASS is out
of all available RASSes collected by the research staff and the lowest RASS
recorded by the bedside nursing team, if available.
